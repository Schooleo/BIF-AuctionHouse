    ...
    <div className='relative group h-full'>
      ...
      >
        ...
        <div className='p-3 sm:p-3.5 flex-1 flex flex-col gap-0.5 overflow-hidden'>
          ...
          <h3
            className='text-base sm:text-lg font-bold text-gray-900 line-clamp-2 leading-tight h-12 overflow-hidden break-words'
            title={name}
          >
            {name}
          </h3>
          ...
          <div className='flex flex-col gap-1 mt-1'>
            ...
            <div className='flex flex-wrap items-baseline gap-1 text-primary-blue'>
              <span className='text-lg sm:text-xl font-extrabold flex-shrink-0'>{formatPrice(currentPrice)}</span>
            </div>
