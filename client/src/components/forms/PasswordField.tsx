...
const PasswordField: React.FC<FormField> = ({ 
  label,
  className = '',
  error = '',
  isRequired = true,
      ...
      <div className="flex flex-col w-full">
        <div className="w-full relative">
            <input
              ...
              className={`
                w-full rounded-md px-4 py-2 pr-10 border
            ...
            >
              {showPassword ? (
                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" className="bi bi-eye-slash" viewBox="0 0 640 640">
