...
const WonAuctionsTab: React.FC = () => {
  ...
  const [auctionToDelete, setAuctionToDelete] = useState<AuctionItem | null>(
    null
  );
    ...
    return (
      <div className="text-center py-12 text-gray-500">
        ...
        <button
          ...
          className="px-6 py-2 bg-primary-blue text-white rounded-full hover:scale-105 transition"
        >
          Join Auctions Now
        </button>
      </div>
      ...
      >
        <p className="text-gray-700">
          ...
          <span className="font-semibold">
            {auctionToDelete?.seller?.name || "this seller"}
          </span>
          ?
        </p>
