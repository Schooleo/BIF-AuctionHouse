...
const RateSellerModal: React.FC<RateSellerModalProps> = ({
  ...
  return (
    <PopUpWindow
      ...
      title={initialScore ? `Update Rating for ${sellerName}` : `Rate ${sellerName}`}
      submitText={initialScore ? 'Update Rating' : 'Submit Rating'}
      isLoading={loading}
    >
      <div className='space-y-6'>
        <p className='text-sm text-gray-600'>
          How was your experience with this seller? This rating will affect their reputation score.
        </p>
        ...
        <div className='flex gap-4 justify-center'>
          ...
          >
            <ThumbsDown size={24} className={score === -1 ? 'fill-current' : ''} />
