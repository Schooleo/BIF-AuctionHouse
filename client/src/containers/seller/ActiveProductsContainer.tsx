...
const ActiveProductsContainer: React.FC = () => {
  ...
  return (
    <div className="flex-1 p-8">
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <h1 className="text-2xl font-bold text-gray-900">Current Products</h1>
...
export default ActiveProductsContainer;
