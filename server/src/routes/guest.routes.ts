...
// Import Zod schemas
import { viewProductsSchema, viewProductDetailParamsSchema } from "../schemas/guest/index.schema";
...
router.get("/product/:id", validate(viewProductDetailParamsSchema, "params"), viewProductDetail);
